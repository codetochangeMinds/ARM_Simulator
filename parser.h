...
int execute(int pc)
{
    ...
    if(lexeme[pc]=="Add"||lexeme[pc]=="add" || lexeme[pc]=="ADD")
    {
        if((lexeme[pc+2]==",") && (lexeme[pc+4]==","))
        {
            ...
            {
                if(stoi(&lexeme[pc+1][1])<13 && stoi(&lexeme[pc+3][1])<13 && stoi(&lexeme[pc+5][1])<13)
                {
                    prog = pc+6;
                    return 0;
                }
            ...
            {
                if(stoi(&lexeme[pc+1][1])<13 && stoi(&lexeme[pc+3][1])<13)
                {
                    prog = pc+6;
                    return 0;
                }
    ...
    {
        //Ldr rd,[rop1,#Imm]
        if((lexeme[pc+1][0]=='r') && (lexeme[pc+4][0]=='r') && (lexeme[pc+6][0]=='#'))
            {
                if((lexeme[pc+2]==","))
                {
                    if(lexeme[pc+3]=="[" && lexeme[pc+7]=="]" && (lexeme[pc+5]==","))
                    {
                        if(stoi(&lexeme[pc+1][1])<13 && stoi(&lexeme[pc+4][1])<13)
                        {
                            prog = pc + 8;
                            return 0;
                        }
        ...
        //Ldr rd,[rop1]
        else if(lexeme[pc+1][0]=='r' && lexeme[pc+4][0]=='r' &&  lexeme[pc+2]==",")
        {
